...
const ReviewCard = ({userRating}) => {

    const {image,review,name,location} = userRating;
    return (
        <div className="bg-gray-800 font-poppins">

            <figure className="max-w-screen-md h-72 md:h-96 lg:h-80 p-10 border border-yellow-100">
                ...
                <blockquote>
                    <p className="text-sm md:text-xl font-semibold text-gray-900 dark:text-white">{review} </p>
                </blockquote>
                <figcaption className="flex items-center mt-6 space-x-3">
                    <img className="w-6 h-6 rounded-full" src={image} alt="profile picture"/>
                        <div className="flex items-center divide-x-2 divide-gray-300 dark:divide-gray-700">
                            ...
                            <cite className="pl-3 text-sm text-gray-500 dark:text-gray-400">{location}</cite>
                        </div>
                </figcaption>
            </figure>
